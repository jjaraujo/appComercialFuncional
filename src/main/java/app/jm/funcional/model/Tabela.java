...
public abstract class Tabela implements Serializable {
	...
	/**
	 * Busca o nome da classe, que será sempre o mesmo da tabela.
	 * 
	 * @param minusculo
	...
	/**
	 * @param carregaMapNovamente - se true, os dados da tabela serÃ£o carregados novamente no map
...
//********
	...
	/**
	 * Verifica se a tabela é uma entidade
	 */
